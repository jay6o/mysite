...
export default function Hero({ className }: { className: string }) {
  ...
  return (
    <div className="w-full flex justify-center items-center w-full">
      <motion.div
        className={`${className} h-[calc(100vh-6rem)] flex justify-center items-center flex-col w-2/3 relative`}
        variants={heroTextVariants}
        initial="hidden"
        whileInView="visible"
        transition={{ duration: 0.7, ease: "easeInOut" }}
      >
        <h1 className="w-5/6 font-normal text-5xl pb-12 lg:pl-12 text-left z-10">____ is a software agency that grows brands digitally</h1>
        <div className="w-5/6 text-left lg:pl-12">
