...
export default function Nav() {
  return (
    <nav className="flex justify-row justify-between h-[6rem] min-h-fit items-center border border-b-2 border-black bg-[#f2f2f2]/95 backdrop-blur-xs sticky top-0 z-10">
